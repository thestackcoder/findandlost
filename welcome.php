...
<body>
    ...
    <div class="container">
        <div class="row">
            <?php
            $sql = "SELECT item_id, color, photo, description, created_at, category.name FROM items INNER JOIN category ON items.category_id = category.category_id;";
            ...
            ?>
                    <div class="col-md-3">
                        <div class="card">
                            ...
                            <a href="detail_item.php" class="btn btn-primary" data-toggle="modal" data-target="#myModal">View Details</a>
                        </div>
                    </div>  
            <?php
                    }
