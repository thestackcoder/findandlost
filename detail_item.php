...
<body>
    ...
    <div class="container">
        <div class="row">
            <?php
            $item_id = $_GET['id'];
            $sql = "SELECT item_id, color, photo, description, phone_number, found_place, created_at, category.name FROM items INNER JOIN category 
            ...
            ?>
                    <div class="col-md-1">
                        <a class="btn btn-default" href="welcome.php">Go Back</a>
                    </div>
                    <div class="col-md-4">
                        <div class="card">
